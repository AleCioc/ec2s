...
if not Path(os.path.join(os.getcwd(), "Results")).exists():
    ...
    os.mkdir(Path(os.path.join(os.getcwd(), "Results", city, "hub_cps")))    
elif not Path(os.path.join(os.getcwd(), "Results", city)).exists():
    os.mkdir(Path(os.path.join(os.getcwd(), "Results", city)))
    os.mkdir(Path(os.path.join(os.getcwd(), "Results", city, "hub_cps")))    
elif not Path(os.path.join(os.getcwd(), "Results", city, "hub_cps")).exists():
    os.mkdir(Path(os.path.join(os.getcwd(), "Results", city, "hub_cps")))    
...
sim_stats_df.to_pickle("Results/" + city + "/hub_cps/costnocost.pickle")